...
//const char* api_url = "https://airiq.ashutosh7i.repl.co/sensordata";
//
...
//
//  String payload = "{\"gas1\": 200,\"gas2\": 300,\"gas3\": 400,\"distance1\": 500}";
//
...
// create JSON object
  ...
  json["gas1"] = mq_02_value;
  json["gas2"] = analogRead(mq_07);
  json["gas3"] = analogRead(mq_135);
  json["distance1"] = cm;
